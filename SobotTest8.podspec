#
#  Be sure to run `pod spec lint SobotTest8.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  #
   ...
   s.source       = { :git => "https://github.com/Sobot-ios/SobotTest8.git", :tag => "0.0.1" }
  ...
  #
   ...
   s.source_files  = "include", "SobotTest8/**/*"
